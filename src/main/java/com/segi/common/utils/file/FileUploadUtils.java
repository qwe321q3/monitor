package com.segi.common.utils.file;

import com.segi.common.exception.file.FileNameLengthLimitExceededException;
import com.segi.framework.config.SegiConfig;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = SegiConfig.getProfile();
    ...
    private static final String encodingFilename(String filename, String extension)
    {
        ...
        filename = UUID.fromString(filename + System.nanoTime() + counter++).toString() + extension;
        return filename;
    }
