package com.segi.project.monitor.job.service;

import com.segi.common.constant.ScheduleConstants;
import com.segi.common.support.Convert;
import com.segi.common.utils.StringUtils;
import com.segi.project.monitor.job.domain.Job;
import com.segi.project.monitor.job.mapper.JobMapper;
import com.segi.project.monitor.job.util.ScheduleUtils;
...
public class JobServiceImpl implements IJobService
{
    ...
    {
        job.setMisfirePolicy(StringUtils.isEmpty(job.getMisfirePolicy())?ScheduleConstants.MISFIRE_DEFAULT:job.getMisfirePolicy());
        int rows = jobMapper.updateJob(job);
        if (rows > 0)
        {
            ScheduleUtils.updateScheduleJob(scheduler, job);
